...
(function() {
  var FIASCalculator, FinalScore, ReviewLevel, Score, ScoreColor, fixValue;
  ...
  Score = (function() {
    ...
    messages = [["Equivalent to a single partial", "A small handful of views", "It's everywhere, like the plague"], ["Nothing - it's straight forward", "I understand what it's doing, but I'm not 100% sure about parts", "It's freaking greek"], ["C'mon - it's a copy change", "I could see some potential for problems, but they seem unlikely to have humongous impact", "I can imagine about 400 ways this blows up"]];
  ...
  ReviewLevel = (function() {
    ...
    messages = ["(needs one +1)", "(needs two +1s)", "(needs two +1s and full QA)"];

    function ReviewLevel(index) {
  ...
  FinalScore = (function() {
    ...
    FinalScore.prototype.message = function() {
      var emoji, url;
      url = "" + window.location.origin + window.location.pathname + (this.queryString());
      emoji = (function() {
        switch (this.index) {
          case 0:
            return ":ok_hand:";
